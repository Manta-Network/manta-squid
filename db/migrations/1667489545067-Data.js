module.exports = class Data1667489545067 {
  name = 'Data1667489545067'

  async up(db) {
    await db.query(`CREATE TABLE "delagator_account" ("id" character varying NOT NULL, "delegations" jsonb, "total_staked" numeric NOT NULL, "status" text NOT NULL, CONSTRAINT "PK_e7d6946e9020302b2ef45175123" PRIMARY KEY ("id"))`)
    await db.query(`CREATE TABLE "collator_account" ("id" character varying NOT NULL, "self_bond" numeric NOT NULL, "delegation_count" integer NOT NULL, "total_bond" numeric NOT NULL, CONSTRAINT "PK_0e7c577a63b63613e74b1218bb0" PRIMARY KEY ("id"))`)
    await db.query(`CREATE TABLE "chain_state" ("id" character varying NOT NULL, "delagator_count" integer NOT NULL, "active_collator_count" integer NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "block_number" integer NOT NULL, CONSTRAINT "PK_e28e46a238ada7cbbcf711b3f6c" PRIMARY KEY ("id"))`)
  ...
  async down(db) {
    await db.query(`DROP TABLE "delagator_account"`)
